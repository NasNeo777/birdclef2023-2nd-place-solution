...
cfg.output_path = {
    ...
    "train_ce": "outputs/cnn_b3ns/pytorch/train_ce",
    "train_bce": "outputs/cnn_b3ns/pytorch/train_bce",
    #"finetune": "outputs/cnn_b3ns/pytorch/finetune",
}

cfg.final_model_path = "outputs/cnn_b3ns/pytorch/train_bce/last.ckpt"
cfg.onnx_path = "outputs/cnn_b3ns/onnx"
...
cfg.loss = {
    ...
    "pretrain_bce": "bce",
    "train_ce": "ce",
    "train_bce": "bce_soft_auc",
    #"finetune": "bce_soft_auc",
}
